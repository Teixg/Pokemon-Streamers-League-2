...
const FORMAT_RULES = [
  {
    ...
    desc: 'Cada streamer juega su propia partida de forma independiente. No hay enfrentamientos directos entre participantes hasta superar la liga (Estan permitidos los combates amistosos).',
  },
  {
    icon: Skull,
    color: '#f43f5e',
  ...
  },
  {
    icon: Trophy,
    color: '#fbbf24',
    title: 'Objetivo: 8 medallas, liga + torneo final',
    desc: 'El objetivo es derrotar a los 8 líderes de gimnasio y completar la Liga Pokémon. Despues viene el torneo final! .',
  },
  {
    icon: Flame,
    color: '#f97316',
    title: 'Streams en directo',
    desc: 'Las partidas se juegan en stream. El progreso se actualiza diariamente en esta web.',
  },
];
    ...
    <div className="min-h-screen bg-[#1e1b4b] px-4 py-12">
      <div className="mx-auto max-w-7xl">
        <PageHeader
          ...
          title="EL EVENTO"
          subtitle="Todo sobre el Pokémon Streamers League 2 — el torneo Randomlocke de la comunidad hispana"
        />
        ...
        {/* Reglas del Randomlocke */}
        <FadeInSection delay="0.1s">
          <section className="mb-16">
            <h2 className="font-['Press_Start_2P'] text-xl sm:text-2xl mb-2 text-gradient">
              Reglas del torneo
            </h2>
            <p className="font-['Nunito'] text-sm text-gray-400 mb-8">
              El torneo combina las reglas <span className="text-white font-semibold">Nuzlocke</span> con un{' '}
              <span className="text-[#a78bfa] font-semibold">Randomlocke</span>. Dos capas de dificultad que hacen cada partida única e irrepetible.
            </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="font-['Nunito'] text-xs text-gray-500 uppercase tracking-widest">Nuzlocke</span>
                  <div className="h-px flex-1 bg-white/10" />
                </div>
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <div className="h-px flex-1 bg-[#7c3aed]/30" />
                  <span className="font-['Nunito'] text-xs text-[#a78bfa] uppercase tracking-widest">Randomlocke</span>
                  <div className="h-px flex-1 bg-[#7c3aed]/30" />
                </div>
                <div className="flex flex-col gap-3">
                  {RANDOMLOCKE_RULES.map((r) => (
                    <div key={r.title} className="rounded-xl border border-[#7c3aed]/30 bg-[#7c3aed]/5 px-5 py-4 flex gap-3">
                      <span className="text-xl shrink-0 mt-0.5">{r.emoji}</span>
                      <div>
                        <h3 className="font-['Nunito'] font-bold text-white text-sm mb-0.5">{r.title}</h3>
                        <p className="font-['Nunito'] text-xs text-gray-400 leading-relaxed">{r.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <p className="font-['Nunito'] text-xs text-gray-500 mt-4">
